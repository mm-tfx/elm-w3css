...
var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {showModule: a, showMenu: b, showAccordion: c, animations: d};
	});
var _user$project$Model$AnimationsModule = {ctor: 'AnimationsModule'};
var _user$project$Model$AccordionModule = {ctor: 'AccordionModule'};
...
var _user$project$Model$Zoom = {ctor: 'Zoom'};
var _user$project$Model$Opacity = {ctor: 'Opacity'};
...
var _user$project$Msg$StartAnimations = function (a) {
	return {ctor: 'StartAnimations', _0: a};
};
var _user$project$Msg$ShowAnimations = {ctor: 'ShowAnimations'};
var _user$project$Msg$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$Msg$OpenAccordion = {ctor: 'OpenAccordion'};
var _user$project$Msg$ShowAccordion = {ctor: 'ShowAccordion'};
		...
		switch (_p0.ctor) {
			...
			case 'OpenAccordion':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{showAccordion: !model.showAccordion}),
					{ctor: '[]'});
			case 'ShowAnimations':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$W3css_Types$ClassList = function (a) {
	return {ctor: 'ClassList', _0: a};
};

var _user$project$W3css_Animations$animateSpin = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-spin', _1: true});
var _user$project$W3css_Animations$animateFading = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-animate-fading', _1: true});
var _user$project$W3css_Animations$animateZoom = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-animate-zoom', _1: true});
var _user$project$W3css_Animations$animateOpacity = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-animate-opacity', _1: true});
var _user$project$W3css_Animations$animateRight = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-animate-right', _1: true});
var _user$project$W3css_Animations$animateLeft = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-animate-left', _1: true});
var _user$project$W3css_Animations$animateBottom = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-animate-bottom', _1: true});
var _user$project$W3css_Animations$animateTop = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-animate-top', _1: true});
...
var _user$project$W3css_Utils$node = F4(
	function (string, $class, options, children) {
		return A3(
			_elm_lang$html$Html$node,
			string,
			_user$project$W3css_Utils$applyOptions(
				{
					ctor: '::',
					_0: _user$project$W3css_Utils$initialClass($class),
					_1: options
				}),
			children);
	});
...
var _user$project$W3css_Button$block = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-block', _1: true});
var _user$project$W3css_Button$onLinkClick = function (msg) {
	return _user$project$W3css_Types$Attribute(
		A3(
			_elm_lang$html$Html_Events$onWithOptions,
			'click',
...
var _user$project$W3css_Colors$black = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-black', _1: true});
...
var _user$project$W3css_Colors$pink = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-pink', _1: true});
var _user$project$W3css_Colors$blue = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-blue', _1: true});
var _user$project$W3css_Colors$red = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-red', _1: true});
...
var _user$project$W3css_Headers$h3 = F2(
	function (options, children) {
		return A2(
...
var _user$project$W3css_Headers$h2 = F2(
	function (options, children) {
		return A2(
...
var _user$project$W3css_Headers$h1 = F2(
	function (options, children) {
		return A2(
...
var _user$project$W3css_Responsive$third = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-third', _1: true});
var _user$project$W3css_Responsive$half = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-half', _1: true});
...
var _user$project$W3css_Round$roundXLarge = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-round-xlarge', _1: true});
var _user$project$W3css_Round$roundLarge = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-round-large', _1: true});
var _user$project$W3css_Round$roundSmall = _user$project$W3css_Types$ClassList(
	{ctor: '_Tuple2', _0: 'w3-round-small', _1: true});
...
var _user$project$View$showAnimations = function (show) {
	var _p0 = show;
	switch (_p0.ctor) {
		case 'Top':
			return _user$project$W3css_Animations$animateTop;
		case 'Bottom':
			return _user$project$W3css_Animations$animateBottom;
		case 'Left':
			return _user$project$W3css_Animations$animateLeft;
		case 'Right':
			return _user$project$W3css_Animations$animateRight;
		case 'Opacity':
			return _user$project$W3css_Animations$animateOpacity;
		case 'Zoom':
			return _user$project$W3css_Animations$animateZoom;
		case 'Fading':
			return _user$project$W3css_Animations$animateFading;
		case 'Spin':
			return _user$project$W3css_Animations$animateSpin;
		default:
			return _user$project$W3css_Utils$class('');
	}
};
var _user$project$View$accordionModule = function (showAccordion) {
	var showAccordion_ = showAccordion ? _user$project$W3css_Utils$class('w3-show') : _user$project$W3css_Utils$class('w3-hide');
	return {
		ctor: '::',
		_0: A2(
			_user$project$W3css_Button$btn,
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$W3css_Colors$black,
					_1: {
						ctor: '::',
						_0: _user$project$W3css_Button$onClick(_user$project$Msg$OpenAccordion),
						_1: {ctor: '[]'}
					}
				}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Open Section'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				_user$project$W3css_Container$div,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _user$project$W3css_Animations$animateLeft,
							_1: {ctor: '[]'}
						}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Section 1'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Something after accordion'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _user$project$View$animationModule = function (show) {
	return {
		ctor: '::',
		_0: _user$project$View$headerModule('Animations'),
		_1: {
			ctor: '::',
			_0: A2(
				_user$project$W3css_Button$btn,
				{
					ctor: '::',
					_0: _user$project$W3css_Button$onClick(
						_user$project$Msg$StartAnimations(_user$project$Model$Top)),
					_1: {
						ctor: '::',
						_0: _user$project$W3css_Colors$black,
						_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A2(
						_user$project$W3css_Button$btn,
						{
							ctor: '::',
							_0: _user$project$W3css_Button$onClick(
								_user$project$Msg$StartAnimations(_user$project$Model$Bottom)),
							_1: {
								ctor: '::',
								_0: _user$project$W3css_Colors$black,
								_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: A2(
								_user$project$W3css_Button$btn,
								{
									ctor: '::',
									_0: _user$project$W3css_Button$onClick(
										_user$project$Msg$StartAnimations(_user$project$Model$Left)),
									_1: {
										ctor: '::',
										_0: _user$project$W3css_Colors$black,
										_1: {ctor: '[]'}
								...
								_1: {
									...
									_0: A2(
										_user$project$W3css_Button$btn,
										{
											ctor: '::',
											_0: _user$project$W3css_Button$onClick(
												_user$project$Msg$StartAnimations(_user$project$Model$Right)),
											_1: {
												ctor: '::',
												_0: _user$project$W3css_Colors$black,
												_1: {ctor: '[]'}
										...
										_1: {
											...
											_0: A2(
												_user$project$W3css_Button$btn,
												{
													ctor: '::',
													_0: _user$project$W3css_Button$onClick(
														_user$project$Msg$StartAnimations(_user$project$Model$Zoom)),
													_1: {
														ctor: '::',
														_0: _user$project$W3css_Colors$black,
														_1: {ctor: '[]'}
												...
												_1: {
													...
													_0: A2(
														_user$project$W3css_Button$btn,
														{
															ctor: '::',
															_0: _user$project$W3css_Button$onClick(
																_user$project$Msg$StartAnimations(_user$project$Model$Opacity)),
															_1: {
																ctor: '::',
																_0: _user$project$W3css_Colors$black,
																_1: {ctor: '[]'}
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Opacity'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														...
														_1: {
															...
															_0: A2(
																_user$project$W3css_Button$btn,
																{
																	ctor: '::',
																	_0: _user$project$W3css_Button$onClick(
																		_user$project$Msg$StartAnimations(_user$project$Model$Fading)),
																	_1: {
																		ctor: '::',
																		_0: _user$project$W3css_Colors$black,
																		_1: {ctor: '[]'}
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Fading'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																...
																_1: {
																	...
																	_0: A2(
																		_user$project$W3css_Button$btn,
																		{
																			ctor: '::',
																			_0: _user$project$W3css_Button$onClick(
																				_user$project$Msg$StartAnimations(_user$project$Model$Spin)),
																			_1: {
																				ctor: '::',
																				_0: _user$project$W3css_Colors$black,
																				_1: {ctor: '[]'}
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Spin'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			...
																			},
																			{
																				ctor: '::',
																				_0: A2(
																					_user$project$W3css_Headers$h1,
																					{
																						ctor: '::',
																						_0: _user$project$View$showAnimations(show),
																						_1: {ctor: '[]'}
																					},
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html$text('Animation is fun'),
																						_1: {ctor: '[]'}
																					}),
																				_1: {ctor: '[]'}
																			}),
		...
		A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(inputCode),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}),
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$W3css_Css$w3css,
			_1: {
				ctor: '::',
														...
														_1: {
															...
															_0: A2(
																_user$project$W3css_Button$button,
																{
																	...
																	_1: {
																		ctor: '::',
																		_0: _user$project$W3css_Button$onClick(_user$project$Msg$ShowAccordion),
																		_1: {ctor: '[]'}
																	}
																},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Accordion'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: A2(
																	_user$project$W3css_Button$button,
																	{
																		...
																		_1: {
																			ctor: '::',
																			_0: _user$project$W3css_Button$onClick(_user$project$Msg$ShowAnimations),
																			_1: {ctor: '[]'}
																		}
																	},
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Animations'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
									...
									_0: A2(
										...
										function () {
											...
											switch (_p1.ctor) {
												...
												case 'AccordionModule':
													return _user$project$View$accordionModule(model.showAccordion);
												default:
													return _user$project$View$animationModule(model.animations);
											}
										}()),
									_1: {ctor: '[]'}
								}),
...
var _user$project$Main$main = A2(
	...
	{init: _user$project$Main$initialState, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$Main$subscriptions})();
